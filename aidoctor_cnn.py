...
pool2_flat = tf.reshape(pool2, [-1, 3 * 64])
				...
				for dropout_rate1 in dropout_list:
					for l2Reg in l2Regularize_list:
						for reg_param1 in regularizer_parameter:
							...
							f.write("batch size = " + str(batch_size) + ", learning rate = " + str(learning_rate) + "\n")
							f.write("training epoch = " + str(training_epoch) + ", dropout rate = " + str(1 - dropout_rate) + "\n\n")
							...
							with tf.Session() as sess:
								...
								plt.savefig("170418 Exp " + str(count_exp) + ".png")
