...
train_data, train_label_train = process_input('train_arrhytmia.txt', train_stat = True) #for the training sake
_, train_label_test = process_input('train_arrhytmia.txt', train_stat = False) #for the testing sake
